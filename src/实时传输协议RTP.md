...
Clark 和 Tennenhouse 在 1990 年首次提出应用级框架思想，Clark 和 Tennenhouse的中心观点是：应用想要对数据传输作出正确的决策，必须对数据有足够的了解。这意味着传输协议应该理解数据中的元素，而且传输层需要尽可能向应用层公开传输细节，以便应用在出现传输异常时能够做出适当的决策。应用层与传输层合作，共同实现可靠的传输。
